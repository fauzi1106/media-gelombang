...
@section('title', 'Kuis Materi Cahaya')
...
@section('content')
  ...
  <div class="quiz-page">
    ...
    <main class="quiz-main">
      ...
      <h1>Kuis Pemahaman Materi Cahaya</h1>
      ...
      <div class="quiz-wrapper" id="quizWrapper" style="display:none;">
        ...
        <div class="nav-row">
          ...
          <div class="legend-vertical">
            <div class="legend-item"><span class="legend-dot legend-notyet"></span> Belum dijawab</div>
            <div class="legend-item"><span class="legend-dot legend-current"></span> Sedang aktif</div>
            <div class="legend-item"><span class="legend-dot legend-answered"></span> Sudah dijawab</div>
          </div>
        </div>
      ...
      <div class="modal-overlay" id="resultModal">
        <div class="modal">
          ...
          <button id="resultOkBtn">OK</button>
        </div>
      </div>
...
@section('scripts')
  ...
  <script>
    const NEXT_PAGE = "{{ url('fenomena_cahaya') }}";
    const REVIEW_PAGE = "{{ url('sifat_cahaya') }}";
