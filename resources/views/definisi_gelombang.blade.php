...
<div class="materi-gelombang">
  ...
  <main class="content">
    ...
    <section id="page-dari-getaran" class="subpage" style="display:none;">
      ...
      <ul>
        <li>Memetik senar gitar: awalnya senar bergetar, lalu getaran itu merambat sebagai <b>gelombang bunyi</b> di udara.</li>
        <li>Menjatuhkan batu ke air: titik tumbukan bergetar, lalu pola gangguan merambat sebagai <b>riak gelombang</b> di permukaan air.</li>
      </ul>
    ...
    <section id="page-besaran" class="subpage" style="display:none;">
      ...
      <ul>
        <li><b>Amplitudo (A)</b> : simpangan maksimum dari posisi setimbang.</li>
        <li><b>Periode (T)</b> : waktu satu getaran.</li>
        <li><b>Frekuensi (f)</b> : banyaknya getaran per detik.</li>
        <li><b>Panjang gelombang (λ)</b> : jarak satu bentuk gelombang lengkap.</li>
        <li><b>Cepat rambat (v)</b> : seberapa cepat gelombang menjalar.</li>
      </ul>
      <p>Hubungan penting antara besaran-besaran ini:</p>
      ...
      <h3 style="margin-top:18px;">Ringkasan</h3>
      <ul>
        <li>Getaran: gerak bolak–balik di sekitar posisi setimbang.</li>
        <li>Gelombang: getaran yang merambat, membawa energi.</li>
        <li>Besaran penting: A, T, f, λ, dan v.</li>
        <li>Rumus utama: <b>f = 1/T</b> dan <b>v = λ f</b>.</li>
      </ul>
    </section>
      ...
      <section id="page-latihan" class="subpage" style="display: none;">
        ...
        <div class="latihan-tabs-wrapper">
          ...
          <div class="latihan-tabs-header">
            <button type="button"
                    class="latihan-tab-btn latihan-tab-active"
                    data-target="latihan-1">
              Frekuensi dari Periode
            </button>

            <button type="button"
                    class="latihan-tab-btn"
    ...
    <button class="next-btn" onclick="location.href='{{ url('pengantar_gelombang') }}'" style="margin-top:10px;">← Materi Sebelumnya</button>
    <button class="next-btn" onclick="location.href='{{ url('jenis_gelombang') }}'" style="margin-top:10px;">Materi Selanjutnya →</button>
